...
Interpretation:
A majority of countries on the higher end of the SDG 10 histogram generally come from the OECD and E. Europe & C. Asia regions, while a majority of countries on the lower end generally come from the LAC and Sub-Saharan Africa regions. In comparison to the SDG 4 histogram, the regions seem to be much less polarized, meaning that some countries from each region can be found towards opposite sides as the majority of countries from those regions. Although higher scores tend to have higher counts, a decent amount of low scores of mid-to-high counts, which shows a need for improve in reduced inequalities across most, if not all, regions.